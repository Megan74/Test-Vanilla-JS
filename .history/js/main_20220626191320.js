import dataService from '/js/service/data.service.js';
import TasksTableComponent from '/js/_components/tasks-table.component.js';
...
(function (window, document) {
    ...
    async function init() {
        tasksTable = await new TasksTableComponent(); //async/await added to avoid unresolved promises
     ...
     function updateTable() {
        ...
        return dataService.getTasks().then(onTranslationsReady);
