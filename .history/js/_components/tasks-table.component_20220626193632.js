window.TasksTableComponent = (function (window) {
    ...
    //TasksTableComponent render the global function with tasks as 
    //parameters
    return function  (tasks) {

        var self = this;
       
        self.tasks = toString(tasks);
        ...
        function getLineElement(task) {
            ...
            for (var i = 0; i < self.columns.length; i++) {
                var col = self.columns[i];
                columns.push(`<td>${task[col.property]}</td>`);
            }
        ...
        function getAggregatedValues(tasks) {
            ...
            for(var i = 0; i < tasks.length; i++) {
                ...
                for(var j = 0; j < self.columns.length; j++) {
                    ...
                    }else if (!aggregatedValues.hasOwnProperty(col.property)){
...
module.export = TasksTableComponent;