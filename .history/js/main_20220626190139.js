...
(function (window, document) {
    ...
    async function init() {
     ...
     function updateTable() {
        ...
        async function onTranslationsReady(translations) {
            if(!translations){
                translations = {types : {}};
            }
            getTasks(translations.types).then((tasks) => {
                ...
                isLoading = false;
                await tasksTable.render(document.getElementById('dataTable'));
            });
        }
    }
